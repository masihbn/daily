...
--
-- Before running the 0009 section, create the test user in the test project's
-- dashboard (Authentication -> Users -> Add user, Auto Confirm User). 0009 refuses
-- to run unless auth.users has exactly one row.
